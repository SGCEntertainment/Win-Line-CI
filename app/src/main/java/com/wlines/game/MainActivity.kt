...
//https://www.zidsworld.com/make-android-webview-support-file-upload/
...
//        }
        ...
        //просить разрешения симки
//        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
//            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_PHONE_STATE)) {
//            } else { ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.READ_PHONE_STATE), 2) } }
...
//        val savedString = sharedPreference.getString("url","https://www.google.com/")
        ...
        if (token==""){
            ...
            //https://betwinnef.com/BtymF7
            //d8x9vlmvxl7gzbxjt5k4gjghnkssjmt9
            val site = "https://betwinnef.com/BtymF7/?_lp=1&_token=$token&offer_id=\"$offer_id"
            web.loadUrl(site)
        }
